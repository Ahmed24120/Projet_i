    ...
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 font-sans relative overflow-hidden">
      ...
      <aside className={`${sidebarOpen ? 'w-72 px-6' : 'w-20 px-3'} bg-white/80 backdrop-blur-xl border-r border-gray-200/50 transition-all duration-300 flex flex-col fixed h-full z-40 left-0 top-0 shadow-2xl shadow-indigo-500/5`}>
        ...
        <nav className="flex-1 space-y-2 overflow-y-auto custom-scrollbar">
          <Link href="/professor/dashboard" className="flex items-center gap-3 px-4 py-3.5 rounded-2xl text-gray-500 hover:bg-gray-50 hover:text-purple-600 font-medium transition-all duration-200 group">
            <LayoutDashboard size={22} className="group-hover:scale-110 transition-transform" />
            {sidebarOpen && <span>Tableau de bord</span>}
          </Link>

          <Link href="/professor/exams" className="flex items-center gap-3 px-4 py-3.5 rounded-2xl bg-purple-600 text-white font-bold shadow-lg shadow-purple-200 transition-all duration-200 hover:shadow-xl hover:shadow-purple-300/50">
            <FileText size={22} />
            {sidebarOpen && <span>Mes Examens</span>}
          </Link>

          <Link href="/professor/students" className="flex items-center gap-3 px-4 py-3.5 rounded-2xl text-gray-500 hover:bg-gray-50 hover:text-purple-600 font-medium transition-all duration-200 group">
            <Users size={22} className="group-hover:scale-110 transition-transform" />
            {sidebarOpen && <span>Etudiants</span>}
          </Link>

          <Link href="/professor/alerts" className="flex items-center gap-3 px-4 py-3.5 rounded-2xl text-gray-500 hover:bg-gray-50 hover:text-purple-600 font-medium transition-all duration-200 group">
                        ...
                        <div key={ex.id} className="group bg-gradient-to-br from-gray-50/80 to-slate-50/80 backdrop-blur-sm rounded-[2rem] p-7 border border-gray-200/70 shadow-md shadow-gray-200/40 hover:shadow-xl hover:shadow-gray-300/50 transition-all duration-300 flex flex-col md:flex-row md:items-center justify-between gap-6">
                          ...
                          <div className="flex items-center gap-3">
                            <Button
                              ...
                              className="rounded-2xl px-6 py-5 bg-indigo-50 text-indigo-700 hover:bg-indigo-600 hover:text-white border border-indigo-200 shadow-sm hover:shadow-xl transition-all duration-300 font-bold text-sm group/download"
                            >
